...
/* eslint-env node */
// This sort order was generated by wdio
...
exports.config = {
  ...
  //
  specs: ['./test/journeys/features/**/*.feature'],
  // Patterns to exclude.
  exclude: [
  ...
  cucumberOpts: {
    require: ['./test/journeys/steps/**/*.js'], // <string[]> (file/dir) require files before executing features
